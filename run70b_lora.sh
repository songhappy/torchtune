#!/bin/bash
#PBS -N guoqiong_lora_70b       
#PBS -q prod
#PBS -l walltime=2:30:00
#PBS -l select=1
#PBS -l filesystems=flare
#PBS -A Intel-Aurora
#PBS -o output/prof_70b_lora.log  
#PBS -e output/prof_70b_lora.log  
...
# nohup xpu-smi dump -m 2,18 -i 1 > /home/songhappy/git/torchtune/output/llama3_3/xpu_mem_log_lora.txt 2>&1 &
...
#     output_dir=/home/songhappy/git/torchtune/output/llama3_3/70b_lora_t8 \
...
# start_sec=$(date +%s)
# echo "***********start lora t12"
# tune run  --nproc_per_node 12 lora_finetune_distributed --config /home/songhappy/git/torchtune/recipes/configs/llama3_3/70B_lora.yaml \
#     device=xpu   seed=123 dataset.packed=True log_level=DEBUG\
#     tokenizer.path=/home/songhappy/models/Llama-3.3-70B-Instruct/original/tokenizer.model \
#     checkpointer.checkpoint_dir=/home/songhappy/models/Llama-3.3-70B-Instruct/ \
#     output_dir=/home/songhappy/git/torchtune/output/llama3_3/70b_lora_t12 \
#     max_steps_per_epoch=10 tokenizer.max_seq_len=512 batch_size=2 profiler.enabled=False \
#     > 70b_lora_t12
